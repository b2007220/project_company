        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
            <li class="nav-item">
                <a href="#" class="nav-link align-items-middle px-0 text-white">
                    ...
                    <span class=" d-none d-sm-inline text-uppercase">Trang chủ</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="#submenu1" data-bs-toggle="collapse" class="nav-link px-0 align-items-middle text-white">
                    <i class="fs-4 bi-speedometer2"></i>
                    <span class=" d-none d-sm-inline text-white text-uppercase">Quản lý Sản phẩm</span>
                </a>
                <ul class="collapse show nav flex-column " id="submenu1" data-bs-parent="#menu">
                    <li class="w-100">
                        <a href="product.html" class="nav-link px-0 text-white">
                            ...
                            <span class="d-none d-sm-inline text-uppercase">Sản phẩm</span>
                        </a>
                    </li>
                    <li>
                        <a href="category.html" class="nav-link px-0 text-white">
                            ...
                            <span class="d-none d-sm-inline text-uppercase">Loại sản phẩm</span>
                        </a>
                    </li>
                    <li>
                        <a href="discount.html" class="nav-link px-0 text-white">
                            ...
                            <span class="d-none d-sm-inline text-uppercase">Loại giảm giá</span>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                <a href="../index.html" class="nav-link px-0 align-items-middle text-white">
                    ...
                    <span class=" d-none d-sm-inline text-uppercase">Rời trang Admin</span></a>
            </li>
        </ul>
    </div>
</div>
